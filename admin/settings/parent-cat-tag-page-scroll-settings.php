...
<?php
/*-----------------------------------------------------------------------------------
WC PSAD Parent Cat & Tag Page Scroll Settings
...
class WC_PSAD_Parent_Cat_Tag_Page_Scroll_Settings extends WC_PSAD_Admin_UI
{
	 ...
	 */
	public $form_key = 'woo_psad_parent_cat_tag_page_scroll_settings';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Parent Cat & Tag Page Scroll Settings successfully saved.', 'wc_psad' ),
				'error_message'		=> __( 'Error: Parent Cat & Tag Page Scroll Settings can not save.', 'wc_psad' ),
				'reset_message'		=> __( 'Parent Cat & Tag Page Scroll Settings successfully reseted.', 'wc_psad' ),
			);
		...
		add_action( $this->plugin_name . '_settings_psad_endless_scroll_tag_container_start_before', array( $this, 'psad_endless_scroll_tag_container_start' ) );
		add_action( $this->plugin_name . '_settings_psad_endless_scroll_tag_container_end_after', array( $this, 'psad_endless_scroll_tag_container_end' ) );
		
		add_action( $this->plugin_name . '_settings_psad_endless_scroll_tag_tyle_container_start_before', array( $this, 'psad_endless_scroll_tag_tyle_container_start' ) );
		add_action( $this->plugin_name . '_settings_psad_endless_scroll_tag_tyle_container_end_after', array( $this, 'psad_endless_scroll_tag_tyle_container_end' ) );
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'parent-cat-tag-page-scoll',
			'label'				=> __( 'Parent Cat & Tag Page Scroll', 'wc_psad' ),
			'callback_function'	=> 'wc_psad_parent_cat_tag_page_scroll_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				...
				'id'		=> 'psad_endless_scroll_tag_container_start',
           	),
			array(  
			...
			array(
                'type' 		=> 'heading',
				'class'		=> 'psad_endless_scroll_tag_tyle_container',
				'id'		=> 'psad_endless_scroll_tag_tyle_container_start',
           	),
			array(
			...
			array(
                'type' 		=> 'heading',
				'class'		=> 'psad_endless_scroll_tag_tyle',
				'id'		=> 'psad_endless_scroll_tag_tyle_container_end',
           	),
			
			array(
                'type' 		=> 'heading',
				'id'		=> 'psad_endless_scroll_tag_container_end',
           	),
        ));
	}
	
	public function psad_endless_scroll_tag_container_start() {
		echo '<div class="psad_endless_scroll_tag_container_start">';	
	}
	public function psad_endless_scroll_tag_container_end() {
		echo '</div>';	
	}
	
	public function psad_endless_scroll_tag_tyle_container_start() {
		echo '<div class="psad_endless_scroll_tag_tyle_container_start">';	
	}
	public function psad_endless_scroll_tag_tyle_container_end() {
		echo '</div>';	
	}
...
(function($) {
	...
	$(document).ready(function() {
		...
		if ( $("input.psad_endless_scroll_tag:checked").val() == 'yes') {
			$(".psad_endless_scroll_tag_container_start").css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} );
		} else {
			$(".psad_endless_scroll_tag_container_start").css( {'visibility': 'hidden', 'height' : '0px', 'overflow' : 'hidden'} );
		}
		
		if ( $("select.psad_endless_scroll_tag_tyle").val() == 'click') {
			$(".psad_endless_scroll_tag_tyle_container_start").css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} );
		} else {
			$(".psad_endless_scroll_tag_tyle_container_start").css( {'visibility': 'hidden', 'height' : '0px', 'overflow' : 'hidden'} );
		}
		
		if ( $("input.psad_es_products_bt_type:checked").val() == 'link') {
			$(".psad_es_tag_click_more_linked_container").css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} );
			$(".psad_es_tag_click_more_bt_container").css( {'visibility': 'hidden', 'height' : '0px', 'overflow' : 'hidden'} );
		} else {
			$(".psad_es_tag_click_more_linked_container").css( {'visibility': 'hidden', 'height' : '0px', 'overflow' : 'hidden'} );
			$(".psad_es_tag_click_more_bt_container").css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} );
		}
			
		$(document).on( "a3rev-ui-onoff_checkbox-switch", '.psad_endless_scroll_tag', function( event, value, status ) {
			if ( status == 'true' ) {
				$(".psad_endless_scroll_tag_container_start").hide().css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} ).slideDown();
			} else {
				$(".psad_endless_scroll_tag_container_start").slideUp();
			}
		});
		
		$("select.psad_endless_scroll_tag_tyle").on( 'change', function() {
			if ( $(this).val() == 'click' ) {
				$(".psad_endless_scroll_tag_tyle_container_start").hide().css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} ).slideDown();
			} else {
				$(".psad_endless_scroll_tag_tyle_container_start").slideUp();
			}
		});
		
		$(document).on( "a3rev-ui-onoff_checkbox-switch", '.psad_es_products_bt_type', function( event, value, status ) {
			if ( status == 'true' ) {
				$(".psad_es_tag_click_more_linked_container").hide().css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} ).slideDown();
				$(".psad_es_tag_click_more_bt_container").slideUp();
			} else {
				$(".psad_es_tag_click_more_linked_container").slideUp();
				$(".psad_es_tag_click_more_bt_container").hide().css( {'visibility': 'visible', 'height' : 'auto', 'overflow' : 'inherit'} ).slideDown();
			}
		});
...
global $wc_psad_parent_cat_tag_page_scroll_settings;
$wc_psad_parent_cat_tag_page_scroll_settings = new WC_PSAD_Parent_Cat_Tag_Page_Scroll_Settings();

/** 
 * wc_psad_parent_cat_tag_page_scroll_settings_form()
 * Define the callback function to show subtab content
 */
function wc_psad_parent_cat_tag_page_scroll_settings_form() {
	global $wc_psad_parent_cat_tag_page_scroll_settings;
	$wc_psad_parent_cat_tag_page_scroll_settings->settings_form();
}
